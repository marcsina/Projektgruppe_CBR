										...
										if($check == 0)
										{
											echo "
												<tr>
													...
													<td>
                                                        <a href='http://medausbild.de/php/profil.php?username=".$user['username']."'>"
														.$user['username']."
                                                           </a>
													</td>
							...
							if(sessionID != user.id) {
								alreadyChallengedUsers_array.forEach(alreadyChallengedUser => {
									if(user.id == alreadyChallengedUser.userID2) {
										if(check == 0) {
											count++;
											$("#table_user").find('tbody').append("<tr><td>"+count+"</td><td><a href='http://medausbild.de/php/profil.php?username="+ user.username+"'>"+ user.username+"</a></td><td class='table_style_uebersicht'>Warte auf Annahme</td></tr>");
											check = 1;
										}
									}
								});
