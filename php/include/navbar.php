		...
		if($logged == 'out')
		{
         ...
         <div class="collapse navbar-collapse navbar-right navbar-ex1-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menuItem"><a href="/Projektgruppe/php/Quiz_uebersicht.php"><?php echo $pendingChallenges; ?>Quiz <i class="icon_table"></i><span class="badge bg-important">12</span></a>
                        </li>
