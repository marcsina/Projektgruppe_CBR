...
function getCaseValuesFromDatabase(database, arrayCases) {
	if (database === "") {
		...
		xmlhttp.open("GET", "http://medausbild.de/php/include/getCaseValues.php", false);
		xmlhttp.send();
...
function getCasesFromDatabase(database, arrayCases) {
	if (database === "") {
		...
		xmlhttp.open("GET", "http://medausbild.de/php/include/getCases.php", false);
		xmlhttp.send();
	}
}
...
function getCategoriesFromDatabase(database, array_symptoms) {
	if (database === "") {
		...
		xmlhttp.open("GET", "http://medausbild.de/php/include/getCategories.php", false);
		xmlhttp.send();
	}
}
